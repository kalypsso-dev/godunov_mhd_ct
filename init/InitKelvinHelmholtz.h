 ...
 */
#ifndef KALYPSSO_GODUNOV_MHD_CT_INIT_KELVIN_HELMHOLTZ_H_
#define KALYPSSO_GODUNOV_MHD_CT_INIT_KELVIN_HELMHOLTZ_H_
...
public:
  ...
  InitKelvinHelmholtzDataFunctor(orchard_key_view_t<device_t> orchard_keys,
 ...
 * User data init is actually done in InitKelvinHelmholtzDataFunctor
 *
...
public:
  // ===========================================================
  // ===========================================================
  InitKelvinHelmholtzRefineFunctor(orchard_key_view_t<device_t> orchard_keys,
                                   int32_t                      local_num_octants,
                                   ConfigMap const &            config_map,
                                   HydroParams                  params,
                                   FieldMap<models::MHD>  fm,
...
// ====================================================================
/**
 * Hydrodynamical kelvin_helmholtz Test.
...
#endif // KALYPSSO_GODUNOV_MHD_CT_INIT_KELVIN_HELMHOLTZ_H_
