 ...
 *
 */
#ifndef KALYPSSO_GODUNOV_MHD_CT_MODELS_MHD_UTILS_H_
#define KALYPSSO_GODUNOV_MHD_CT_MODELS_MHD_UTILS_H_
...
find_speed_alfven(MHDStateCell const & qvar)
{
  ...
  using MHD = kalypsso::godunov_mhd_ct::models::MHD;
 ...
 */
KOKKOS_INLINE_FUNCTION auto
compute_primitives(MHDStateCell const & u, real_t & c, MHDSettings const & mhd_settings)
{
  // makes enum MHD::VarId available
  using MHD = kalypsso::godunov_mhd_ct::models::MHD;
 ...
 */
KOKKOS_INLINE_FUNCTION auto
compute_primitives(MHDStateCell const & u, MHDSettings const & mhd_settings)
{
  [[maybe_unused]] real_t c;
  return compute_primitives(u, c, mhd_settings);
} // compute_primitives
...
#endif // KALYPSSO_GODUNOV_MHD_CT_MODELS_MHD_UTILS_H_
